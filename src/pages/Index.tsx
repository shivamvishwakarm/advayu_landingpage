  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-r from-pink-500/20 to-orange-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "2s" }}></div>
        <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "4s" }}></div>
      ...
      {/* Navigation Bar */}
      <nav className="border-b border-gray-800/50 bg-gray-950/80 backdrop-blur-xl sticky top-0 z-50 transition-all duration-300">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#how-it-works" className="text-gray-300 hover:text-white transition-all duration-300 font-medium hover:scale-105 transform relative group">
                How it Works
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="#features" className="text-gray-300 hover:text-white transition-all duration-300 font-medium hover:scale-105 transform relative group">
                Features
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="#testimonials" className="text-gray-300 hover:text-white transition-all duration-300 font-medium hover:scale-105 transform relative group">
                Testimonials
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <Button variant="outline" className="border-gray-700/50 text-gray-300 hover:bg-gray-800/50 hover:text-white transition-all duration-300 hover:scale-105 transform backdrop-blur-sm">Login</Button>
      ...
      {/* Hero Section */}
      <section className="pt-20 pb-32 bg-gradient-to-b from-gray-900/50 to-gray-950 relative z-10">
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-950/50 to-purple-950/50 border border-blue-800/30 rounded-full text-blue-300 text-sm font-medium mb-8 animate-fade-in backdrop-blur-sm">
              <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-green-400 rounded-full mr-3 animate-pulse"></div>
              Now Live in 50+ UPI Apps
              <Sparkles className="w-4 h-4 ml-2 text-yellow-400" />
            </div>
            <h1 className="text-5xl lg:text-8xl font-black mb-8 leading-tight tracking-tight animate-fade-in" style={{ animationDelay: "0.2s" }}>
              ...
              <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-gradient-x relative">
                UPI Apps
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-400/20 via-purple-400/20 to-pink-400/20 blur-lg -z-10"></div>
              </span>
            </h1>
            <p className="text-xl lg:text-2xl mb-12 text-gray-300 max-w-4xl mx-auto leading-relaxed font-light animate-fade-in" style={{ animationDelay: "0.4s" }}>
              Reach customers right at the point of payment with geo- and behavior-targeted offers that drive{" "}
              <span className="text-transparent bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text font-semibold">instant action</span>.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in" style={{ animationDelay: "0.6s" }}>
              <Button size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold px-8 py-4 text-lg h-14 border-0 transition-all duration-300 hover:scale-105 transform hover:shadow-2xl relative overflow-hidden group">
                <span className="relative z-10 flex items-center">
                  Book a Demo <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" />
                </span>
                <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </Button>
              <Button size="lg" variant="outline" className="border-gray-600/50 text-gray-300 hover:bg-gray-800/50 hover:text-white px-8 py-4 text-lg h-14 transition-all duration-300 hover:scale-105 transform backdrop-blur-sm group">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: "0.8s" }}>
              <div className="text-center transform hover:scale-110 transition-all duration-300 group">
                <div className="text-3xl lg:text-4xl font-black text-white mb-2 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">50M+</div>
                <div className="text-gray-400 text-sm font-medium">Monthly Users</div>
              </div>
              <div className="text-center transform hover:scale-110 transition-all duration-300 group">
                <div className="text-3xl lg:text-4xl font-black text-white mb-2 bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">300%</div>
                <div className="text-gray-400 text-sm font-medium">Avg ROI Boost</div>
              </div>
              <div className="text-center transform hover:scale-110 transition-all duration-300 group">
                <div className="text-3xl lg:text-4xl font-black text-white mb-2 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">1-Tap</div>
                <div className="text-gray-400 text-sm font-medium">Redemption</div>
              </div>
              <div className="text-center transform hover:scale-110 transition-all duration-300 group">
                <div className="text-3xl lg:text-4xl font-black text-white mb-2 bg-gradient-to-r from-pink-400 to-red-400 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">500+</div>
      ...
      <section className="py-24 bg-gray-950/50 relative z-10">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl lg:text-6xl font-black mb-8 text-white tracking-tight bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent">What is Advayu?</h2>
            <p className="text-xl lg:text-2xl text-gray-300 leading-relaxed mb-12 font-light">
              ...
              creating the <span className="text-transparent bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text font-semibold">perfect moment</span> for conversion.
            </p>
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-gray-800/50 rounded-3xl p-8 backdrop-blur-sm hover:bg-gray-800/50 transition-all duration-500 transform hover:scale-105 relative overflow-hidden group">
              ...
              <div className="text-lg lg:text-xl text-gray-300 italic font-light relative z-10">
                "No app downloads, no friction – just <span className="text-transparent bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text font-semibold">instant value</span> for both brands and customers."
              </div>
            </div>
          </div>
        </div>
      ...
      {/* How it Works */}
      <section id="how-it-works" className="py-24 bg-gradient-to-br from-gray-900/50 to-gray-950/50 relative z-10">
        <div className="container mx-auto px-6">
      ...
      <section id="features" className="py-24 bg-gray-950/50 relative z-10">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
      ...
      {/* Who It's For */}
      <section className="py-24 bg-gradient-to-br from-gray-900/50 to-gray-950/50 relative z-10">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
      ...
      {/* Testimonials */}
      <section id="testimonials" className="py-24 bg-gradient-to-br from-gray-900/50 to-gray-950/50 relative z-10">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-br from-gray-900/50 to-gray-950/50 relative z-10 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-500/10"></div>
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl lg:text-6xl font-black mb-8 text-white tracking-tight bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent">Ready to Transform Your Customer Acquisition?</h2>
            <p className="text-xl lg:text-2xl text-gray-200 mb-12 leading-relaxed font-light">
              Join <span className="text-transparent bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text font-semibold">500+ brands</span> already reaching customers at the perfect moment. 
              Start your Advayu campaign today and see the difference contextual offers can make.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button size="lg" className="bg-white hover:bg-gray-100 text-gray-900 font-semibold px-8 py-4 text-lg h-14 border-0 transition-all duration-300 hover:scale-105 transform hover:shadow-2xl relative overflow-hidden group">
                <span className="relative z-10 flex items-center">
                  Book a Demo <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" />
                </span>
              </Button>
              <Button size="lg" variant="outline" className="border-gray-400/50 text-white hover:bg-white/10 px-8 py-4 text-lg h-14 transition-all duration-300 hover:scale-105 transform backdrop-blur-sm">
                Launch a Campaign
              </Button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl lg:text-6xl font-black mb-8 text-white tracking-tight bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent">Get Started Today</h2>
              <p className="text-xl lg:text-2xl text-gray-300 font-light">
                Tell us about your brand and we'll create a <span className="text-transparent bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text font-semibold">custom campaign strategy</span> for you.
              </p>
            </div>
            <ContactForm />
          </div>
