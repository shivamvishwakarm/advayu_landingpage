...
const Index = () => {
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <nav className="border-b border-gray-800 bg-gray-950/80 backdrop-blur-md sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="text-2xl font-bold text-white">Advayu</div>
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white border-0">Get Started</Button>
            </div>
          </div>
        </div>
      </nav>
      ...
      {/* Hero Section */}
      <section className="pt-20 pb-32 bg-gradient-to-b from-gray-900 to-gray-950">
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center px-4 py-2 bg-blue-950/50 border border-blue-800/30 rounded-full text-blue-300 text-sm font-medium mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <Button size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold px-8 py-4 text-lg h-14 border-0">
                Book a Demo <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
              <Button size="lg" variant="outline" className="border-gray-600 text-gray-300 hover:bg-gray-800 hover:text-white px-8 py-4 text-lg h-14">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
              ...
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm">Avg ROI Boost</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-2">1-Tap</div>
                <div className="text-gray-400 text-sm">Redemption</div>
              </div>
              <div className="text-center">
      ...
      <section className="py-24 bg-gray-950">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl lg:text-5xl font-bold mb-8 text-white">What is Advayu?</h2>
      ...
      <section id="how-it-works" className="py-24 bg-gray-900">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-white">How It Works</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Two powerful targeting methods to reach your ideal customers
            </p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <Card className="p-8 border border-gray-800 bg-gray-900/50 backdrop-blur-sm hover:bg-gray-800/50 transition-all duration-300">
              <CardHeader className="text-center pb-8">
                ...
                <CardTitle className="text-2xl font-bold text-white mb-2">Offline Stores</CardTitle>
                <CardDescription className="text-gray-400 text-lg">Geo-Targeted Reach</CardDescription>
              </CardHeader>
            ...
            <Card className="p-8 border border-gray-800 bg-gray-900/50 backdrop-blur-sm hover:bg-gray-800/50 transition-all duration-300">
              <CardHeader className="text-center pb-8">
                ...
                <CardTitle className="text-2xl font-bold text-white mb-2">D2C/Online Brands</CardTitle>
                <CardDescription className="text-gray-400 text-lg">Behavior-Based Targeting</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
      ...
      <section id="features" className="py-24 bg-gray-950">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-white">Why Brands Choose Advayu</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
      ...
      <section className="py-24 bg-gray-900">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-white">Who It's For</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
      ...
      <section className="py-24 bg-gray-950">
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-bold mb-8 text-white">Distribution Partners</h2>
      ...
      <section id="testimonials" className="py-24 bg-gray-900">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-white">What Our Partners Say</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
      ...
      <section className="py-24 bg-gray-950">
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-bold mb-8 text-white">About Us</h2>
              <p className="text-xl text-gray-300 leading-relaxed max-w-4xl mx-auto">
      ...
      <section className="py-24 bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl lg:text-5xl font-bold mb-8 text-white">Ready to Transform Your Customer Acquisition?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button size="lg" className="bg-white hover:bg-gray-100 text-gray-900 font-semibold px-8 py-4 text-lg h-14 border-0">
                Book a Demo <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
              <Button size="lg" variant="outline" className="border-gray-400 text-white hover:bg-white/10 px-8 py-4 text-lg h-14">
                Launch a Campaign
              </Button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl lg:text-5xl font-bold mb-8 text-white">Get Started Today</h2>
